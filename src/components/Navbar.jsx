    ...
    <div>
        <div className="container py-8 mx-auto flex">
            ...
            <div className="wrapper flex ml-auto">
                <Link to={link2} className='my-auto ml-5 border-4 border-[#2395FF] py-4 px-6 rounded-xl'><p className='text-xl font-semibold'>{tittle2}</p></Link>   
                <Link to={link} className='my-auto ml-5 border-4 border-[#2395FF] py-4 px-6 rounded-xl'><p className='text-xl font-semibold'>{tittle}</p></Link>   
